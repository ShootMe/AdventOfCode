...
namespace AdventOfCode.Y2019 {
    public class Puzzle12 : ASolver {
        private Moon[] moons;
        public Puzzle12(string input) : base(input) { Name = "The N-Body Problem"; }
        ...
        public override string SolvePart2() {
            ...
            long lcmXY = (stepX * stepY) / Tools.GCD(stepX, stepY);
            return ((lcmXY * stepZ) / Tools.GCD(lcmXY, stepZ)).ToString();
        }
