...
namespace AdventOfCode.Y2020 {
    public class Puzzle02 : ASolver {
        ...
        public Puzzle02(string input) : base(input) { Name = "Password Philosophy"; }
        ...
        private class PasswordEntry {
            ...
            public static implicit operator PasswordEntry(string line) {
                ...
                entry.Low = Tools.ParseInt(line.Substring(0, index1));
                entry.High = Tools.ParseInt(line.Substring(index1 + 1, index2 - index1 - 1));
