...
namespace AdventOfCode.Y2020 {
    public class Puzzle04 : ASolver {
        ...
        public Puzzle04(string input) : base(input) { Name = "Passport Processing"; }

        public override void Setup() {
            passports = Tools.GetSections(Input, ' ');
        }
        ...
        public override string SolvePart2() {
            ...
            for (int i = 0; i < passports.Count; i++) {
                ...
                for (int j = 0; j < fields.Length; j++) {
                    ...
                    if (validations.TryGetValue(type, out validation) && validation(value)) {
                        count++;
                    }
                }
