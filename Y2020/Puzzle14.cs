...
namespace AdventOfCode.Y2020 {
    public class Puzzle14 : ASolver {
        ...
        public Puzzle14(string input) : base(input) { Name = "Docking Data"; }
        ...
        public override string SolvePart1() {
            ...
            for (int i = 0; i < items.Count; i++) {
                ...
                if (item[1] == 'a') {
                    ...
                    int address = Tools.ParseInt(item, "[", "]");
                    long value = Tools.ParseLong(item, " = ");
        ...
        public override string SolvePart2() {
            ...
            for (int i = 0; i < items.Count; i++) {
                ...
                if (item[1] == 'a') {
                    ...
                    long address = Tools.ParseInt(item, "[", "]");
                    long value = Tools.ParseLong(item, " = ");
