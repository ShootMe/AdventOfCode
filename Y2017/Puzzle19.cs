...
namespace AdventOfCode.Y2017 {
    public class Puzzle19 : ASolver {
        ...
        public Puzzle19(string input) : base(input) { Name = "A Series of Tubes"; }
        ...
        public override string SolvePart1() {
            return $"{FindPath(new Point() { X = start % width, Y = start / width }).Item1}";
        }

        [Description("How many steps does the packet need to go?")]
        public override string SolvePart2() {
            return $"{FindPath(new Point() { X = start % width, Y = start / width }).Item2}";
        }

        private Tuple<string, int> FindPath(Point packet) {
            ...
            while (true) {
                ...
                if (next != ' ') {
                    ...
                    return new Tuple<string, int>(sb.ToString(), moves);
                }
            }
        }
    }
